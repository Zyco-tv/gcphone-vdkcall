...
function getContacts(identifier)
    local result = MySQL.Sync.fetchAll("SELECT * FROM phone_users_contacts WHERE phone_users_contacts.identifier = @identifier", {
        ['@identifier'] = getNumberPhone(identifier)
    })
    return result
end
...
function getMessages(identifier)
    ...
    --return MySQLQueryTimeStamp("SELECT phone_messages.* FROM phone_messages LEFT JOIN users ON users.identifier = @identifier WHERE phone_messages.receiver = users.phone_number", {['@identifier'] = getNumberPhone(identifier)})
end
...
function addMessage(source, identifier, phone_number, message)
    ...
    --print(phone_number .. " " .. myPhone .. " " .. message)
